                ...
                <div className='landing__main'>
                    <div className='landing__main-text'>
                        ...
                        <span className='landing__main-text__heading'
                              data-text='Aaaaa&nbsp;Aaaaaa'>Aaaaa&nbsp;Aaaaaa</span>
                        hendrerit id eget metus. Lorem ipsum dolor sit amet,
                        consectetur adipiscing elit. in lorem et arcu facilisis eget posuer
                        <span className='landing__main-text__heading'
                              data-text='Frontend&nbsp;Developer'>Frontend&nbsp;Developer</span>
                        el in felis. Curabitur
                        bibendum non sem non pretium.
                        Duis sed felis a dolor viverra mollis et nec libero. Quisque lacus ex, luctus et odio eu,
                        pretium
                        sed et pretium est. Praesent cursus lacus a mattis posuere. Suspendisse porttitor nulla non
                        neque
                        iaculis, iaculis malesuada enim a ante lobortis malesuada interdum eget magna. Nunc malesuada
                        risus
                        ac arcu fermentum vestibulum. Nullam dolor odio, efficitur at tempus sit amet, efficitur nec
                        nulla.
